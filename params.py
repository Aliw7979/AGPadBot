...
FINISHED_VIEWS = 'بازدید های این تبلیغ تکمیل شده است🙏'
WANT_ADD_BUTTON = 'آیا مایل هستید به تبلیغ دکمه اضافه شود؟'
FILL_BUTTON_TEXT = 'لطفا متن مربوط به دکمه را بفرستید.'
FILL_BUTTON_LINK = '''لطفا لینک مربوط به دکمه را بفرستید.'''
NEXT_BUTTON_CONFIRMATION = '''آیا مایل هستید دکمه بعدی را اضافه کنید؟'''
BUTTONS_ADDED = 'دکمه ها اضافه شدند.'
BUTTON_ADDED = 'دکمه مورد نظر اضافه شد.'
CANT_USE_ATSIGN = '''لینک شما نباید با علامت @ شروع شود.
در صورتی که میخواهید آدرس کانال تلگرامی را وارد کنید باید آن را به فرمت url به ما بدهید.
به طور مثال: 
https://t.me/asrgooyeshpardaz'''
#Api stuff
...
YES = 'بله'
NO = 'خیر'
SKIP_BUTTON = 'رد کردن اضافه کردن دکمه'
WANT_ADD_ANOTHER_BUTTON = 'می‌خواهم دکمه دیگری اضافه کنم'


#conv
SELECT_PACKAGE, SEND_IMAGE, SEND_TEXT, BUTTON_CONFIRM, BUTTON_TEXT, BUTTON_LINK, CONFIRMATION = range(7)
